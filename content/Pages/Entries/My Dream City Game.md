...
This game idea is inspired by Mini Motorways & rymdkapsel. The simplistic, minimalist style of these two games is what I would like to replicate in a city builder game. 

![[mini-motorways-game.png|600]]

![[rymdkapsel-game.png|600]]
...
### Businesses 
* Sells products.
* Requires `energy`, `water`, and an employee to operate.
### Homes
* Houses residences.
* Requires `energy` and `water` to be livable. 
### Citizens
...
For more details, checkout my [[City Game — Game Design Document|Game Design Doc]]. 